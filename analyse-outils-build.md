...
Pour ce qui est de la fréquence des mise a jours. La dernière version majeur de Gradle a été lancer le 8 novembre 2019 (6.0) et depuis a eu 2 version mineur (6.1 et 6.2) la 6.2 étant lancer le 17 fevrier 2020. Contrairement Apache Ant et sur la meme version majeur (1.10) depuis 2016. Cependant elle possède des mises a jours mineurs à frèquences régulières (3~5 mois). La dernière version mineur stable de Apache Ant (1.10.7) étais le 5 septembre 2019.
